...
function Icon() {
  ...
  return (
    <div
      ...
      <button onClick={() => setHi(!hi)}>click</button>
      <svg
        style={{
          strokeWidth: "2px",
          width: "500px",
        ...
        viewBox="0 0 500 733">
        <path
          d="M348.14 514.61c5.28-2.32 8.69-4.11 8.69-4.11S357 508 341 471.67s-56.17-30.86-56.31-30.94c-2.94-5.34-5.29-16.25-5.19-16.32 15.37-10.6 21.83-36.41 21.83-36.41s13.7 2.42 14-14.25 8.13-4.25 1.13-17.25c0 0 10 6.25 9-3.25S313.25 344 313.25 344 338 331 329 330.5s-17.25 4.75-17.25 4.75 7.76-9.5 3.63-17-7.13 12-7.13 12-.28-29.77-39.43-34c-14.65-1.58 0 10.66 0 10.66S247.5 293 234.5 298s4.25 10.25 4.25 10.25-13.29.48-21.26 2.91c-7.44 2.27-24.24 6.84 7 7.59 0 0-14.25 7.75-19.5 19.5s1 13.75 11 6.5c0 0-9.82 15.75 7.72 23.25a35.38 35.38 0 00.76 7.17c7.92 39.77 17.11 52.38 32.5 54 .08 0 1.41 8.2 2.35 13.51 0 0-34.67 1.94-47 15-7.61 8.07-13.36 33.86-16.69 58.86a49.5 49.5 0 0012.05 1.9l-1.47.5S202 556.5 210 569.83s20.5 8.67 31.75 9.79c9.49 1 10.51.7 14.75 5.32 3.36 3.67 6.62 9.18 10.35 5.86a9 9 0 00-.61 1.45c-2.25 7.13 5 4.75 5 4.75-1.87 6.25 5.81 3.51 5.81 3.51a6.84 6.84 0 00-.45 1.88c-.37 5.5 6.94 3.24 6.94 3.24a2.56 2.56 0 002.68 2.51c2.08-.31 1.74.67 9.37-8.37 8.13-9.63 24.13-16.13 42.5-31.13s10.05-54 10.05-54zm-122 30.72c0-17.19 2.8-28.23 2.8-28.23 1.47-.25 3-.53 4.52-.85.07 17.34.58 32.18 1.28 43.54l7.42 1.22c-7.53.33-16.06-2.08-16.03-15.68zm57.32 31.35l.11-.85a35.66 35.66 0 00-7.82-9.33h37c-.86.64-1.7 1.25-2.54 1.82l.35-1.82a17.53 17.53 0 00-.47 1.9 76.77 76.77 0 01-10.09 5.85c-5.56-1.15-11.35.07-16.55 2.43zm42.05-26.35c-1.62 6.4-7.19 12-12.71 16.16L320 560c.63-7.51-1.43-35.91-1.43-35.91 2.34-.39 4.71-.9 7.06-1.5h-.07a58.08 58.08 0 01-.06 27.74z"
          className={`${position < 100 ? true : false}`}></path>
        <g>
          <path
          ...
          <path
            ...
            className="stroke"></path>
          <path
            d="M271.25 597s-7.25 2.38-5-4.75 18.85-21.08 33.75-18c0 0 22-10.08 25.5-23.92a58.08 58.08 0 000-27.72M234 478c-1.09 34-.44 62.76.73 81.79"
            className="stroke"></path>
          <path
          ...
          <path
            ...
            className="stroke"></path>
          <path
            d="M310.08 569.08a9.57 9.57 0 01.5-2.58m-29.85-.58l-4.12 1.34"
            className="fill"></path>
        </g>
      </svg>
    </div>
